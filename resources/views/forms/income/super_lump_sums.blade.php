<section>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="number"
               name="super_lump_sums[lump_sum_count]"
    ...
    @php
        ...
        $payments = $superLumpSums['payments'] ?? [[]];
    @endphp

    <div id="super-lump-container">
        @foreach($payments as $i => $lump)
            <div class="grin_box_border mb-4 super-lump-block" data-index="{{ $i }}">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <select name="super_lump_sums[payments][{{ $i }}][lump_day]" class="form-control border-dark">
                    ...
                    <div class="col-md-4 mb-3">
                        <select name="super_lump_sums[payments][{{ $i }}][lump_month]" class="form-control border-dark">
                    ...
                    <div class="col-md-4 mb-3">
                        <select name="super_lump_sums[payments][{{ $i }}][lump_year]" class="form-control border-dark">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="super_lump_sums[payments][{{ $i }}][tax_withheld]" class="form-control border-dark"
                               value="{{ $lump['tax_withheld'] ?? '' }}" placeholder="00.00$">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="choosing-business-type-text">Taxable Component - Taxed element</label>
                        <input type="text" name="super_lump_sums[payments][{{ $i }}][taxed_component]" class="form-control border-dark"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="super_lump_sums[payments][{{ $i }}][untaxed_component]" class="form-control border-dark"
                               value="{{ $lump['untaxed_component'] ?? '' }}" placeholder="00.00$">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="choosing-business-type-text">Tax-free component</label>
                        <input type="text" name="super_lump_sums[payments][{{ $i }}][tax_free_component]" class="form-control border-dark"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input custom-radio"
                                   type="radio"
                                   name="super_lump_sums[payments][{{ $i }}][is_death_benefit]"
                                   value="1"
                                   id="deathYes{{ $i }}"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="super_lump_sums[payments][{{ $i }}][payer_abn]" class="form-control border-dark"
