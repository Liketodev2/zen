<section>
    ...
    <div class="grin_box_border mb-4" id="otherIncomeContainer">
        @php
            $otherIncomes = $incomes->other_income['info'] ?? [];
            $dynamicBlocks = array_values($otherIncomes);
        @endphp
        ...
        @if(count($dynamicBlocks) > 0)
            @foreach($dynamicBlocks as $index => $block)
                <div class="row other-income-block mb-3" data-index="{{ $index }}">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="other_income[info][{{ $index }}][other_income_type]" class="form-control border-dark">
                            <option value="">Select</option>
                            <option value="lottery" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'lottery' ? 'selected' : '' }}>Winnings from investment related lotteries and gambling</option>
                            <option value="forex" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'forex' ? 'selected' : '' }}>Foreign exchange gains</option>
                            <option value="securities" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'securities' ? 'selected' : '' }}>Gains on traditional securities</option>
                            <option value="financial" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'financial' ? 'selected' : '' }}>Financial investments not shown elsewhere</option>
                            <option value="asset_adjustment" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'asset_adjustment' ? 'selected' : '' }}>Any assessable balancing adjustment when you stop holding a depreciating asset</option>
                            <option value="work_in_progress" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'work_in_progress' ? 'selected' : '' }}>Work-in-progress amounts</option>
                            <option value="ato_interest" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'ato_interest' ? 'selected' : '' }}>ATO interest remitted</option>
                            <option value="reimbursements" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'reimbursements' ? 'selected' : '' }}>Reimbursements of tax-related expenses or election expenses</option>
                            <option value="other" {{ old("other_income.info.$index.other_income_type", $block['other_income_type'] ?? '') == 'other' ? 'selected' : '' }}>Other</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01"
                               name="other_income[info][{{ $index }}][other_income_amount]"
                               class="form-control border-dark"
                               placeholder="00.00$"
                               value="{{ old("other_income.info.$index.other_income_amount", $block['other_income_amount'] ?? '') }}" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01"
                               name="other_income[info][{{ $index }}][bal_adj_financial]"
                               class="form-control border-dark"
                               placeholder="00.00$"
                               value="{{ old("other_income.info.$index.bal_adj_financial", $block['bal_adj_financial'] ?? '') }}" />
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01"
                               name="other_income[info][{{ $index }}][bal_adj_rental]"
                               class="form-control border-dark"
                               placeholder="00.00$"
                               value="{{ old("other_income.info.$index.bal_adj_rental", $block['bal_adj_rental'] ?? '') }}" />
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="choosing-business-type-text">Remaining assessable balancing adjustment</label>
                        <input type="number" step="0.01"
                               name="other_income[info][{{ $index }}][bal_adj_remaining]"
                               class="form-control border-dark"
                               placeholder="00.00$"
                               value="{{ old("other_income.info.$index.bal_adj_remaining", $block['bal_adj_remaining'] ?? '') }}" />
                    </div>
            ...
            @endforeach
        @else
            {{-- One empty block if none exist --}}
            <div class="row other-income-block mb-3" data-index="0">
                <div class="col-md-6 mb-3">
                    <label class="choosing-business-type-text">Other income type</label>
                    <select name="other_income[info][0][other_income_type]" class="form-control border-dark">
                        <option value="">Select</option>
                ...
                <div class="col-md-6 mb-3">
                    <label class="choosing-business-type-text">Amount you received</label>
                    <input type="number" step="0.01"
                           name="other_income[info][0][other_income_amount]"
                           class="form-control border-dark"
                           placeholder="00.00$" />
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <label class="choosing-business-type-text">Assessable balancing adjustment from low value pool relating to financial investments</label>
                    <input type="number" step="0.01"
                           name="other_income[info][0][bal_adj_financial]"
                           class="form-control border-dark"
                           placeholder="00.00$" />
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <label class="choosing-business-type-text">Assessable balancing adjustment from low value pool relating to rental property</label>
                    <input type="number" step="0.01"
                           name="other_income[info][0][bal_adj_rental]"
                           class="form-control border-dark"
                           placeholder="00.00$" />
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <label class="choosing-business-type-text">Remaining assessable balancing adjustment</label>
                    <input type="number" step="0.01"
                           name="other_income[info][0][bal_adj_remaining]"
                           class="form-control border-dark"
                           placeholder="00.00$" />
                </div>
    ...
    <template id="otherIncomeTemplate">
        <div class="row other-income-block mb-3" data-index="__INDEX__">
            <div class="col-md-6 mb-3">
                <label class="choosing-business-type-text">Other income type</label>
                <select name="other_income[info][__INDEX__][other_income_type]" class="form-control border-dark">
                    <option value="">Select</option>
                    <option value="lottery">Winnings from investment related lotteries and gambling</option>
                    <option value="forex">Foreign exchange gains</option>
                    <option value="securities">Gains on traditional securities</option>
            ...
            <div class="col-md-6 mb-3">
                <label class="choosing-business-type-text">Amount you received</label>
                <input type="number" step="0.01" name="other_income[info][__INDEX__][other_income_amount]" class="form-control border-dark" placeholder="00.00$" />
            </div>

            <div class="col-md-6 mb-3">
                <label class="choosing-business-type-text">Assessable balancing adjustment from low value pool relating to financial investments</label>
                <input type="number" step="0.01" name="other_income[info][__INDEX__][bal_adj_financial]" class="form-control border-dark" placeholder="00.00$" />
            </div>

            <div class="col-md-6 mb-3">
                <label class="choosing-business-type-text">Assessable balancing adjustment from low value pool relating to rental property</label>
                <input type="number" step="0.01" name="other_income[info][__INDEX__][bal_adj_rental]" class="form-control border-dark" placeholder="00.00$" />
            </div>

            <div class="col-md-6 mb-3">
                <label class="choosing-business-type-text">Remaining assessable balancing adjustment</label>
                <input type="number" step="0.01" name="other_income[info][__INDEX__][bal_adj_remaining]" class="form-control border-dark" placeholder="00.00$" />
            </div>
        ...
        function refreshIndices() {
            container.querySelectorAll(".other-income-block").forEach((block, index) => {
                ...
                block.querySelectorAll("[name]").forEach(el => {
                    el.name = el.name.replace(/other_income\[info\]\[\d+\]/g, `other_income[info][${index}]`);
                });
            });
        }
